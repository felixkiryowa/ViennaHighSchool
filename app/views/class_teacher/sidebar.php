              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-book"></i> My Subject <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#"><i class="fa fa-plus-circle"></i> Add Student Marks</a></li>
                      <li><a href="#"><i class="fa fa-eye"></i> View Student Marks</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-file"></i> Results <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#"><i class="fa fa-eye"></i> View All Student Marks</a></li>
                    </ul>
                  </li>
