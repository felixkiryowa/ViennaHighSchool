								...
								<table id="datatable-buttons" class="table table-striped table-bordered">
								  ...
								  <tbody>
									<tr>
									  <td>Jonnah</td>
									  <td>Kazibwe</td>
									  <td><button class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" data-toggle="modal" data-target="#AddStudentMark"> Add</button></td>
									</tr>
								  </tbody>
								</table>
							</div>
		...
		<div class="modal fade" style="padding-top: 125px;" tabindex="-1" role="dialog" id="AddStudentMark">
		   <div class="modal-dialog" role="document">
			 ...
			 <div class="modal-header">
				 ...
				 <h4 class="modal-title"><li class="fa fa-plus-circle"></li>  Add Student Mark</h4>
			 </div>
			...
			<div class="modal-body">
				<div class="messages"></div>
				 <div class="form-group"> <!--/here teh addclass has-error will appear -->
					 ...
					 <div class="col-sm-10">
					 <input type="number" class="form-control" id="edit_firstname" name="edit_firstname" placeholder="Enter firstname">
					 </div>
				 </div> 
			</div>
